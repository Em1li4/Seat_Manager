        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    System.out.println("enter the old seat number you want to update");
                    String oldSeatNumber = keyboard.nextLine();
                    System.out.println("enter the new seat number you want to update");
                    seatNumber = keyboard.nextLine();
                    bookingManager.updateBooking(oldSeatNumber, seatNumber);
